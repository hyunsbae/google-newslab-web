        ...
        candidates: {
          ...
          jung: {
            job: [{
              ...
              description: `비정규직과 파트타임 다양한 형태의 노동계약과 일자리를 늘리는 것은 현 산업구조에서 필연적이다.` +
                `문제는 비정규직이 값싼 노동력과 노동착취를 의미하는 단어가 되어 버린 현실에 있다. 노동계약 상태에 대한 정부의 강력한 규칙 제정과 노동조합 역할의 활성화 등을 통해 비정규직 근로자 처우 개선을 해야 한다.`,
